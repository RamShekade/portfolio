            ...
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-lg p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="bg-cyan-600 hover:bg-cyan-500 text-white px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105 font-medium"
                >
                  ramshekade20@gmail.com
                </a>
                <a
                  href="tel:+919156979741"
                  className="bg-slate-700 hover:bg-slate-600 text-white px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105 font-medium"
                >
                  +91 9156979741
                </a>
              </div>
